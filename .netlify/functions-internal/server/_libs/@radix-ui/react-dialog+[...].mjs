...
import { n as createContextScope, t as createContext2 } from "../radix-ui__react-context.mjs";
...
//#endregion
//#region node_modules/thirdweb/node_modules/@radix-ui/react-dialog/node_modules/@radix-ui/react-dismissable-layer/dist/index.mjs
...
var DismissableLayer$1 = import_react.forwardRef((props, forwardedRef) => {
...
var DismissableLayerBranch$1 = import_react.forwardRef((props, forwardedRef) => {
	const context = import_react.useContext(DismissableLayerContext$1);
...
//#endregion
//#region node_modules/thirdweb/node_modules/@radix-ui/react-dialog/node_modules/@radix-ui/react-presence/dist/index.mjs
	...
	useLayoutEffect2(() => {
		if (node) {
			...
			const handleAnimationEnd = (event) => {
				const isCurrentAnimation = getAnimationName$1(stylesRef.current).includes(event.animationName);
...
//#endregion
//#region node_modules/thirdweb/node_modules/@radix-ui/react-dialog/node_modules/@radix-ui/react-focus-guards/dist/index.mjs
var count$1 = 0;
...
//#endregion
//#region node_modules/thirdweb/node_modules/@radix-ui/react-dialog/node_modules/@radix-ui/react-slot/dist/index.mjs
// @__NO_SIDE_EFFECTS__
...
//#endregion
//#region node_modules/thirdweb/node_modules/@radix-ui/react-dialog/dist/index.mjs
var DIALOG_NAME$1 = "Dialog";
var [createDialogContext$1, createDialogScope$1] = createContextScope(DIALOG_NAME$1);
...
var Dialog$1 = (props) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogProvider$1, {
		scope: __scopeDialog,
		triggerRef,
		contentRef,
		contentId: useId(),
...
Dialog$1.displayName = DIALOG_NAME$1;
var TRIGGER_NAME$1 = "DialogTrigger";
var DialogTrigger$1 = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeDialog, ...triggerProps } = props;
	const context = useDialogContext$1(TRIGGER_NAME$1, __scopeDialog);
...
var [PortalProvider$1, usePortalContext$1] = createDialogContext$1(PORTAL_NAME$1, { forceMount: void 0 });
var DialogPortal$1 = (props) => {
	const { __scopeDialog, forceMount, children, container } = props;
	const context = useDialogContext$1(PORTAL_NAME$1, __scopeDialog);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PortalProvider$1, {
		scope: __scopeDialog,
		forceMount,
		children: import_react.Children.map(children, (child) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence$1, {
...
var DialogOverlay$1 = import_react.forwardRef((props, forwardedRef) => {
	...
	const context = useDialogContext$1(OVERLAY_NAME$1, props.__scopeDialog);
	return context.modal ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence$1, {
		present: forceMount || context.open,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogOverlayImpl$1, {
			...overlayProps,
			ref: forwardedRef
		})
	}) : null;
...
var DialogOverlayImpl$1 = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeDialog, ...overlayProps } = props;
	const context = useDialogContext$1(OVERLAY_NAME$1, __scopeDialog);
...
var DialogContent$1 = import_react.forwardRef((props, forwardedRef) => {
	...
	const context = useDialogContext$1(CONTENT_NAME$1, props.__scopeDialog);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence$1, {
		present: forceMount || context.open,
		children: context.modal ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContentModal$1, {
			...contentProps,
			ref: forwardedRef
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContentNonModal$1, {
			...contentProps,
			ref: forwardedRef
		})
	});
...
var DialogContentModal$1 = import_react.forwardRef((props, forwardedRef) => {
	const context = useDialogContext$1(CONTENT_NAME$1, props.__scopeDialog);
	const contentRef = import_react.useRef(null);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContentImpl$1, {
		...props,
		ref: composedRefs,
...
var DialogContentNonModal$1 = import_react.forwardRef((props, forwardedRef) => {
	const context = useDialogContext$1(CONTENT_NAME$1, props.__scopeDialog);
...
var DialogContentImpl$1 = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeDialog, trapFocus, onOpenAutoFocus, onCloseAutoFocus, ...contentProps } = props;
	const context = useDialogContext$1(CONTENT_NAME$1, __scopeDialog);
	const contentRef = import_react.useRef(null);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FocusScope, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DismissableLayer$1, {
			role: "dialog",
	...
	}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TitleWarning$1, { titleId: context.titleId }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DescriptionWarning$1, {
		contentRef,
...
var DialogTitle$1 = import_react.forwardRef((props, forwardedRef) => {
	...
	const context = useDialogContext$1(TITLE_NAME$1, __scopeDialog);
...
var DialogDescription$1 = import_react.forwardRef((props, forwardedRef) => {
	...
	const context = useDialogContext$1(DESCRIPTION_NAME$1, __scopeDialog);
...
var DescriptionWarning$1 = ({ contentRef, descriptionId }) => {
	const MESSAGE = `Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${useWarningContext$1(DESCRIPTION_WARNING_NAME$1).contentName}}.`;
	import_react.useEffect(() => {
...
//#endregion
export { Portal$2 as _, Portal as a, useEscapeKeydown as b, Close$1 as c, Portal$1 as d, Root$1 as f, useControllableState as g, FocusScope as h, Overlay as i, Content$1 as l, Trigger as m, Content as n, Root as o, Title$1 as p, Description as r, Title as s, Close as t, Overlay$1 as u, useId as v, useCallbackRef$1 as x, useLayoutEffect2 as y };
