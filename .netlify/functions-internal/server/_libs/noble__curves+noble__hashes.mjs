...
import { Gn as init_sha2, Kn as sha256$2, bc as randomBytes$2, gc as anumber$1, lt as hmac$2, ut as init_hmac, vc as concatBytes$5, yc as init_utils$1 } from "./@base-org/account+[...].mjs";
import * as nc from "node:crypto";
//#region node_modules/thirdweb/node_modules/@noble/hashes/esm/_assert.js
/**
...
//#endregion
//#region node_modules/thirdweb/node_modules/@noble/hashes/esm/cryptoNode.js
/**
...
//#endregion
//#region node_modules/thirdweb/node_modules/@noble/hashes/esm/utils.js
/**
...
//#endregion
//#region node_modules/thirdweb/node_modules/@noble/hashes/esm/_md.js
/**
...
//#endregion
//#region node_modules/thirdweb/node_modules/@noble/hashes/esm/sha256.js
/**
...
var sha256$1 = /* @__PURE__ */ wrapConstructor$1(() => new SHA256$1());
//#endregion
//#region node_modules/thirdweb/node_modules/@noble/curves/esm/abstract/utils.js
init_utils$1();
init_sha2();
init_hmac();
/**
...
var _0n$12 = /* @__PURE__ */ BigInt(0);
var _1n$14 = /* @__PURE__ */ BigInt(1);
...
function hexToNumber$2(hex) {
	...
	return hex === "" ? _0n$12 : BigInt("0x" + hex);
}
...
var isPosBig$1 = (n) => typeof n === "bigint" && _0n$12 <= n;
...
function bitLen$2(n) {
	let len;
	for (len = 0; n > _0n$12; n >>= _1n$14, len += 1);
	return len;
}
/**
...
*/
var bitMask$2 = (n) => (_1n$14 << BigInt(n)) - _1n$14;
var u8n$2 = (len) => new Uint8Array(len);
var u8fr$2 = (arr) => Uint8Array.from(arr);
/**
...
//#endregion
//#region node_modules/@walletconnect/utils/node_modules/viem/node_modules/@noble/curves/esm/abstract/utils.js
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
function isBytes(a) {
	return a instanceof Uint8Array || ArrayBuffer.isView(a) && a.constructor.name === "Uint8Array";
}
...
function bitLen$1(n) {
	let len;
	for (len = 0; n > _0n$11; n >>= _1n$13, len += 1);
	return len;
}
/**
* Minimal HMAC-DRBG from NIST 800-90 for RFC6979 sigs.
...
var _0n$11, _1n$13, hasHexBuiltin, hexes$1, asciis, isPosBig, bitMask$1, u8n$1, u8fr$1, validatorFns$1;
var init_utils = __esmMin((() => {
	_0n$11 = /* @__PURE__ */ BigInt(0);
	_1n$13 = /* @__PURE__ */ BigInt(1);
	...
	isPosBig = (n) => typeof n === "bigint" && _0n$11 <= n;
	bitMask$1 = (n) => (_1n$13 << BigInt(n)) - _1n$13;
	u8n$1 = (len) => new Uint8Array(len);
...
//#endregion
//#region node_modules/@walletconnect/utils/node_modules/viem/node_modules/@noble/curves/esm/abstract/modular.js
/**
...
function invert$2(number, modulo) {
	...
	let b = modulo;
	let x = _0n$10, y = _1n$12, u = _1n$12, v = _0n$10;
	while (a !== _0n$10) {
		const q = b / a;
		const r = b % a;
		const m = x - u * q;
	...
	if (b !== _1n$12) throw new Error("invert: does not exist");
	return mod$2(x, modulo);
}
function sqrt3mod4(Fp, n) {
	const p1div4 = (Fp.ORDER + _1n$12) / _4n$5;
...
function sqrt5mod8(Fp, n) {
	...
	const n2 = Fp.mul(n, _2n$9);
	const v = Fp.pow(n2, p5div8);
	const nv = Fp.mul(n, v);
	const i = Fp.mul(Fp.mul(nv, _2n$9), v);
...
function tonelliShanks$2(P) {
	...
	return function tonelliSlow(Fp, n) {
		...
		while (!Fp.eql(t, Fp.ONE)) {
			...
			const exponent = _1n$12 << BigInt(M - i - 1);
...
*/
function FpSqrt$2(P) {
	if (P % _4n$5 === _3n$5) return sqrt3mod4;
	if (P % _8n$2 === _5n$2) return sqrt5mod8;
	return tonelliShanks$2(P);
}
function validateField$2(field) {
	return validateObject$1(field, FIELD_FIELDS$2.reduce((map, val) => {
		map[val] = "function";
		return map;
	}, {
		ORDER: "bigint",
...
function FpPow$2(Fp, num, power) {
	...
	if (power === _0n$10) return Fp.ONE;
	if (power === _1n$12) return num;
	let p = Fp.ONE;
	let d = num;
	while (power > _0n$10) {
		if (power & _1n$12) p = Fp.mul(p, d);
		d = Fp.sqr(d);
		power >>= _1n$12;
	}
	return p;
...
function FpLegendre(Fp, n) {
	const p1mod2 = (Fp.ORDER - _1n$12) / _2n$9;
...
function mapHashToField$2(key, fieldOrder, isLE = false) {
	...
	const reduced = mod$2(isLE ? bytesToNumberLE$1(key) : bytesToNumberBE$1(key), fieldOrder - _1n$12) + _1n$12;
	return isLE ? numberToBytesLE$1(reduced, fieldLen) : numberToBytesBE$1(reduced, fieldLen);
}
var _0n$10, _1n$12, _2n$9, _3n$5, _4n$5, _5n$2, _8n$2, FIELD_FIELDS$2;
var init_modular = __esmMin((() => {
	init_utils();
	_0n$10 = BigInt(0), _1n$12 = BigInt(1), _2n$9 = /* @__PURE__ */ BigInt(2), _3n$5 = /* @__PURE__ */ BigInt(3);
	_4n$5 = /* @__PURE__ */ BigInt(4), _5n$2 = /* @__PURE__ */ BigInt(5), _8n$2 = /* @__PURE__ */ BigInt(8);
	FIELD_FIELDS$2 = [
		"create",
		"isValid",
		"is0",
...
//#endregion
//#region node_modules/@walletconnect/utils/node_modules/viem/node_modules/@noble/curves/esm/abstract/curve.js
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
		...
		*/
		wNAF(W, precomputes, n) {
			...
			for (let window = 0; window < wo.windows; window++) {
				...
				n = nextN;
				if (isZero) f = f.add(constTimeNegate$1(isNegF, precomputes[offsetF]));
				else p = p.add(constTimeNegate$1(isNeg, precomputes[offset]));
			}
			return {
				p,
				f
...
var _0n$9, _1n$11, pointPrecomputes$1, pointWindowSizes$1;
...
//#endregion
//#region node_modules/@walletconnect/utils/node_modules/viem/node_modules/@noble/curves/esm/abstract/weierstrass.js
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
...
function weierstrassPoints$2(opts) {
	...
	*/
	...
	const _4a3 = Fp.mul(Fp.pow(CURVE.a, _3n$4), _4n$4);
	const _27b2 = Fp.mul(Fp.sqr(CURVE.b), BigInt(27));
	if (Fp.is0(Fp.add(_4a3, _27b2))) throw new Error("bad curve params: a or b");
	function isWithinCurveOrder(num) {
		return inRange(num, _1n$10, CURVE.n);
	}
	function normPrivateKeyToScalar(key) {
		...
		aInRange("private key", num, _1n$10, N);
		return num;
	}
	...
	*/
	class Point {
		...
		*/
		static normalizeZ(points) {
			const toInv = FpInvertBatch$2(Fp, points.map((p) => p.pz));
		...
		*/
		multiplyUnsafe(sc) {
			...
			aInRange("scalar", sc, _0n$8, N);
			const I = Point.ZERO;
			if (sc === _0n$8) return I;
			if (this.is0() || sc === _1n$10) return this;
			...
			while (k1 > _0n$8 || k2 > _0n$8) {
				if (k1 & _1n$10) k1p = k1p.add(d);
				if (k2 & _1n$10) k2p = k2p.add(d);
				d = d.double();
				k1 >>= _1n$10;
				k2 >>= _1n$10;
			}
		...
		*/
		multiply(scalar) {
			const { endo, n: N } = CURVE;
			aInRange("scalar", scalar, _1n$10, N);
			let point, fake;
			/** See docs for {@link EndomorphismOpts} */
			if (endo) {
		...
		*/
		multiplyAndAddUnsafe(Q, a, b) {
			const G = Point.BASE;
			const mul = (P, a) => a === _0n$8 || a === _1n$10 || !P.equals(G) ? P.multiplyUnsafe(a) : P.multiply(a);
		...
		isTorsionFree() {
			...
			if (cofactor === _1n$10) return true;
			if (isTorsionFree) return isTorsionFree(Point, this);
			throw new Error("isTorsionFree() has not been declared for the elliptic curve");
		}
		clearCofactor() {
			const { h: cofactor, clearCofactor } = CURVE;
			if (cofactor === _1n$10) return this;
	...
	const wnaf = wNAF$2(Point, endo ? Math.ceil(nBitLength / 2) : nBitLength);
	return {
		CURVE,
...
function weierstrass$2(curveDef) {
	...
	const { ProjectivePoint: Point, normPrivateKeyToScalar, weierstrassEquation, isWithinCurveOrder } = weierstrassPoints$2({
		...
		fromBytes(bytes) {
			...
			if (len === compressedLen && (head === 2 || head === 3)) {
				...
				if (!inRange(x, _1n$10, Fp.ORDER)) throw new Error("Point is not on curve");
	...
	function isBiggerThanHalfOrder(number) {
		return number > CURVE_ORDER >> _1n$10;
	}
	...
	*/
	class Signature {
		constructor(r, s, recovery) {
			aInRange("r", r, _1n$10, CURVE_ORDER);
			aInRange("s", s, _1n$10, CURVE_ORDER);
			this.r = r;
			this.s = s;
		...
		static fromDER(hex) {
			const { r, s } = DER$2.toSig(ensureBytes$1("DER", hex));
	...
	*/
	function int2octets(num) {
		aInRange("num < 2^" + nBitLength, num, _0n$8, ORDER_MASK);
	...
	function prepSig(msgHash, privateKey, opts = defaultSigOpts) {
		...
		function k2sig(kBytes) {
			...
			if (s === _0n$8) return;
			let recovery = (q.x === r ? 0 : 2) | Number(q.y & _1n$10);
			let normS = s;
...
var DERErr$1, DER$2, _0n$8, _1n$10, _3n$4, _4n$4;
var init_weierstrass = __esmMin((() => {
	...
	_0n$8 = BigInt(0), _1n$10 = BigInt(1), _3n$4 = BigInt(3), _4n$4 = BigInt(4);
}));
//#endregion
//#region node_modules/@walletconnect/utils/node_modules/viem/node_modules/@noble/curves/esm/_shortw_utils.js
/**
...
//#endregion
//#region node_modules/@walletconnect/utils/node_modules/viem/node_modules/@noble/curves/esm/secp256k1.js
/**
...
function sqrtMod$2(y) {
	...
	const b2 = y * y * y % P;
	const b3 = b2 * b2 * y % P;
	const b11 = pow2$2(pow2$2(pow2$2(b3, _3n, P) * b3 % P, _3n, P) * b3 % P, _2n$7, P) * b2 % P;
	const b22 = pow2$2(b11, _11n, P) * b11 % P;
	const b44 = pow2$2(b22, _22n, P) * b22 % P;
	const b88 = pow2$2(b44, _44n, P) * b44 % P;
	const root = pow2$2(pow2$2(pow2$2(pow2$2(pow2$2(pow2$2(b88, _88n, P) * b88 % P, _44n, P) * b44 % P, _3n, P) * b3 % P, _23n, P) * b22 % P, _6n, P) * b2 % P, _2n$7, P);
	if (!Fpk1$1.eql(Fpk1$1.sqr(root), y)) throw new Error("Cannot find square root");
	return root;
}
var secp256k1P$2, secp256k1N$2, _0n$7, _1n$9, _2n$7, divNearest$2, Fpk1$1, secp256k1$2;
var init_secp256k1 = __esmMin((() => {
	...
	_1n$9 = BigInt(1);
	_2n$7 = BigInt(2);
	divNearest$2 = (a, b) => (a + b / _2n$7) / b;
	Fpk1$1 = Field$2(secp256k1P$2, void 0, void 0, { sqrt: sqrtMod$2 });
...
//#endregion
//#region node_modules/thirdweb/node_modules/@noble/hashes/esm/hmac.js
/**
...
//#endregion
//#region node_modules/thirdweb/node_modules/@noble/curves/esm/abstract/modular.js
/**
* Utils for modular division and finite fields.
* A finite field over 11 is integer number operations `mod 11`.
* There is no division: it is replaced by modular multiplicative inverse.
...
*/
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
var _0n$6 = BigInt(0), _1n$8 = BigInt(1), _2n$6 = /* @__PURE__ */ BigInt(2), _3n$3 = /* @__PURE__ */ BigInt(3);
var _4n$3 = /* @__PURE__ */ BigInt(4), _5n$1 = /* @__PURE__ */ BigInt(5), _8n$1 = /* @__PURE__ */ BigInt(8);
var _9n$1 = /* @__PURE__ */ BigInt(9), _16n$1 = /* @__PURE__ */ BigInt(16);
function mod$1(a, b) {
	const result = a % b;
...
function tonelliShanks$1(P) {
	const legendreC = (P - _1n$8) / _2n$6;
	let Q, S, Z;
	for (Q = P - _1n$8, S = 0; Q % _2n$6 === _0n$6; Q /= _2n$6, S++);
	for (Z = _2n$6; Z < P && pow$1(Z, legendreC, P) !== P - _1n$8; Z++) if (Z > 1e3) throw new Error("Cannot find square root: likely non-prime P");
	if (S === 1) {
		const p1div4 = (P + _1n$8) / _4n$3;
...
function validateField$1(field) {
	return validateObject$2(field, FIELD_FIELDS$1.reduce((map, val) => {
		map[val] = "function";
		return map;
	}, {
		ORDER: "bigint",
...
function mapHashToField$1(key, fieldOrder, isLE = false) {
	...
	if (len < 16 || len < minLen || len > 1024) throw new Error("expected " + minLen + "-1024 bytes of input, got " + len);
	const reduced = mod$1(isLE ? bytesToNumberLE$2(key) : bytesToNumberBE$2(key), fieldOrder - _1n$8) + _1n$8;
	return isLE ? numberToBytesLE$2(reduced, fieldLen) : numberToBytesBE$2(reduced, fieldLen);
}
//#endregion
//#region node_modules/thirdweb/node_modules/@noble/curves/esm/abstract/curve.js
/**
...
function pippenger(c, fieldN, points, scalars) {
	...
	const MASK = bitMask$2(windowSize);
	const buckets = new Array(Number(MASK) + 1).fill(zero);
	const lastBits = Math.floor((fieldN.BITS - 1) / windowSize) * windowSize;
	let sum = zero;
	for (let i = lastBits; i >= 0; i -= windowSize) {
...
//#endregion
//#region node_modules/thirdweb/node_modules/@noble/curves/esm/abstract/weierstrass.js
/**
...
var DER$1 = {
	...
	toSig(hex) {
		...
		const data = ensureBytes$2("signature", hex);
		const { v: seqBytes, l: seqLeftBytes } = tlv.decode(48, data);
		if (seqLeftBytes.length) throw new E("invalid signature: left bytes after parsing");
		const { v: rBytes, l: rLeftBytes } = tlv.decode(2, seqBytes);
		const { v: sBytes, l: sLeftBytes } = tlv.decode(2, rLeftBytes);
...
}, _0n$4 = BigInt(0), _1n$6 = BigInt(1), _3n$2 = BigInt(3);
function weierstrassPoints$1(opts) {
	...
	const toBytes = CURVE.toBytes || ((_c, point, _isCompressed) => {
		const a = point.toAffine();
		return concatBytes$3(Uint8Array.from([4]), Fp.toBytes(a.x), Fp.toBytes(a.y));
	});
	const fromBytes = CURVE.fromBytes || ((bytes) => {
		const tail = bytes.subarray(1);
		return {
...
function weierstrass$1(curveDef) {
	...
	const numToNByteHex = (num) => bytesToHex$2(numberToBytesBE$2(num, CURVE.nByteLength));
	function isBiggerThanHalfOrder(number) {
...
//#endregion
//#region node_modules/thirdweb/node_modules/@noble/curves/esm/_shortw_utils.js
/**
* Utilities for short weierstrass curves, combined with noble-hashes.
* @module
*/
...
function getHash$1(hash) {
	return {
		hash,
		hmac: (key, ...msgs) => hmac$1(hash, key, concatBytes$4(...msgs)),
...
//#endregion
//#region node_modules/thirdweb/node_modules/@noble/curves/esm/secp256k1.js
/**
* NIST secp256k1. See [pdf](https://www.secg.org/sec2-v2.pdf).
*
* Seems to be rigid (not backdoored)
...
var _1n$5 = BigInt(1);
var _2n$4 = BigInt(2);
var divNearest$1 = (a, b) => (a + b / _2n$4) / b;
/**
* √n = n^((p+1)/4) for fields p = 3 mod 4. We unwrap the loop and multiply bit-by-bit.
* (P+1n/4n).toString(2) would produce bits [223x 1, 0, 22x 1, 4x 0, 11, 00]
*/
...
//#endregion
//#region node_modules/ethers/node_modules/@noble/hashes/esm/cryptoNode.js
...
* Same as BigInt(`0b${Array(i).fill('1').join('')}`)
*/
var bitMask = (n) => (_2n$3 << BigInt(n - 1)) - _1n$4;
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
var _0n$2 = BigInt(0), _1n$3 = BigInt(1), _2n$2 = BigInt(2), _3n$1 = BigInt(3);
...
}, _0n = BigInt(0), _1n$1 = BigInt(1), _3n = BigInt(3);
...
//#endregion
export { anumber as A, byteSwap32 as C, wrapConstructor$1 as D, u32$1 as E, abytes$2 as O, Hash$1 as S, toBytes$1 as T, secp256k1$1 as _, Hash as a, hexToNumber$2 as b, createView as c, wrapConstructor as d, bytes as f, output as g, number as h, SHA2 as i, aoutput as j, aexists as k, toBytes as l, hash as m, hmac as n, asyncLoop as o, exists as p, sha256 as r, checkOpts as s, secp256k1 as t, u32 as u, init_secp256k1 as v, isLE$1 as w, sha256$1 as x, secp256k1$2 as y };
