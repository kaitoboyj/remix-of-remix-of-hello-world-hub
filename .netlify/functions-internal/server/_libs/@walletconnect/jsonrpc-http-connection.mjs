...
import { $t as safeJsonParse, E as formatJsonRpcError, N as parseConnectionError, Qt as init_esm, T as isHttpUrl, en as safeJsonStringify, v as init_esm$1 } from "./core+[...].mjs";
...
var import_public_api, Readable, BUFFER, TYPE, Blob, convert, INTERNALS, PassThrough, invalidTokenRegex, invalidHeaderCharRegex, MAP, Headers, INTERNAL, HeadersIteratorPrototype, INTERNALS$1, STATUS_CODES, Response, INTERNALS$2, URL, parse_url, format_url, streamDestructionSupported, Request, URL$1, PassThrough$1, isDomainOrSubdomain, isSameProtocol;
...
//#endregion
//#region node_modules/cross-fetch/dist/node-ponyfill.js
...
var import_node_ponyfill, P, w, E, c, L, O, l, p, v, d, g, f;
var init_index_es = __esmMin((() => {
	import_node_ponyfill = /* @__PURE__ */ __toESM(require_node_ponyfill());
	init_esm();
	init_esm$1();
	P = Object.defineProperty, w = Object.defineProperties, E = Object.getOwnPropertyDescriptors, c = Object.getOwnPropertySymbols, L = Object.prototype.hasOwnProperty, O = Object.prototype.propertyIsEnumerable, l = (r, t, e) => t in r ? P(r, t, {
		enumerable: !0,
		configurable: !0,
		writable: !0,
		value: e
	...
	f = class {
		constructor(t, e = !1) {
			if (this.url = t, this.disableProviderPing = e, this.events = new EventEmitter(), this.isAvailable = !1, this.registering = !1, !isHttpUrl(t)) throw new Error(`Provided URL is not compatible with HTTP connection: ${t}`);
		...
		async send(t) {
			...
			try {
				const e = safeJsonStringify(t), s = await (await (0, import_node_ponyfill.default)(this.url, v(p({}, d), { body: e }))).json();
		...
		async register(t = this.url) {
			...
			try {
				if (!this.disableProviderPing) {
					...
					await (0, import_node_ponyfill.default)(t, v(p({}, d), { body: e }));
				}
				this.onOpen();
			} catch (e) {
...
//#endregion
export { init_index_es as n, index_es_exports as t };
