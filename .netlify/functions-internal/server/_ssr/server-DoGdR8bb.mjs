...
import { n as getResponse, r as requestHandler } from "./request-response-CQEjjZQ9.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DkxIDgzz.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CGmFIyxI.mjs"),
		import("./start-5w5YWSFm.mjs"),
